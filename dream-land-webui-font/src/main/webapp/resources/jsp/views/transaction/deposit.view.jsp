...
<section class="content-header">
	<h1>
		Nạp tiền ngân hàng <%--<small>Nạp tiền ngân hàng</small>--%>
	</h1>
	<ol class="breadcrumb">
		<li>
		...
		<li class="active">
			<a href="${pageContext.request.contextPath}/transaction/deposit">Nạp tiền ngân hàng</a>
		</li>
	</ol>
</section>
...
<section class="content">
		...
		<div class="col-xs-12 col-md-3" style="width: 12%">
			<div class="form-group">
                 <input class="form-control" placeholder="Số tài khoản PayDee" type="text" 
                 		id="paydAccountNo" name="paydAccountNo">
			</div>
		</div>
	...
	<div class="row" style="margin-bottom: 10px;">
		<div class="col-md-12 text-center">
			<button type="button" class="btn btn-blue btn-flat" id="search-deposit" name="search-deposit">
				<i class="fa fa-search"></i>&nbsp;&nbsp;Tìm kiếm
			</button>
			<button type="button" class="btn btn-blue btn-flat" id="to-excel-deposit" name="to-excel-deposit">
				<i class="fa fa-file-excel-o"></i>&nbsp;&nbsp;Xuất báo cáo
			</button>
			<button type="button" class="btn btn-flat btn-blue" id="reset-deposit" name="reset-deposit">
					...
					<table class="table table-hover">
						<thead>
							<tr>
								...
								<th class="text-nowrap">Người nộp</th>
